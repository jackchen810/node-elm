...
class Account extends BaseComponent {
	...
	async changePassword(req, res, next){
        console.log('[http] account changePassword');
	//	var user_account = req.body.user_account;
        ...
        console.log('[http] account changePassword end');
	}

	async revoke(req, res, next){
        console.log('[http] account revoke');
		try{
        ...
        console.log('[http] account revoke end');
	}

	async restore(req, res, next){
        console.log('[http] account restore');
		try{
            var wherestr = {'user_account': req.body.user_account};
			const admin = await DB.AccountTable.findOne(wherestr);
			if(!admin){
        ...
        console.log('[http] account restore end');
	}
	async logout(req, res, next){
        console.log('[http] account logout');
		try{
        ...
        console.log('[http] account end');
	}

	async getAllAdmin(req, res, next) {
        console.log('[http] account list');
        ...
        console.log('[http] account list end');
	}
