'use strict';
console.log('[begin] create http process, pid:', process.pid);
...
app.use(express.static(config.order_channel_dir + '/../'));
app.use(express.static(config.market_channel_dir + '/../'));
...
process.on('unhandledRejection', (reason, p) => {
    ...
    console.log("[http] Unhandled Rejection:", p);
...
console.log('[end] create http process, pid:', process.pid);