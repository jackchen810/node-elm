...
const task_router = require('./task_trade.js');
const riskctrl_router = require('./files_riskctrl.js');
const strategy_router = require('./files_strategy.js');
const order_router = require('./files_order.js');
const market_router = require('./files_market.js');
const log_router = require('./log.js');
const history_router = require('./history_data.js');
const backtest_router = require('./task_backtest.js');
const trade_point_router = require('./trade_point.js');
const download_plan_router = require('./download_plan.js');
const pick_strategy_router = require('./task_pick.js');
