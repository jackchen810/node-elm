'use strict';
const GatewayTx = require("../../process-gateway/gateway_tx");
            ...
            req.on('end',function(){
                ...
                for (var i = 0; i< symbol_array.length; i++) {
                   ...
                   // symbol_array[i];
                    ...
                    //GatewayTx.send(tick_data, 'on_tick', '', 'trader');
                    self.create_bar_min(tick_data, '1', function (barObj) {
                        GatewayTx.send(tick_data, 'on_bar', '1', 'trader');
                        //WorkerHnd.onBar('1', barObj);
                    });
                    self.create_bar_min(tick_data, '5', function (barObj) {
                        GatewayTx.send(tick_data, 'on_bar', '5', 'trader');
...
console.log('create trader IfengMarketClass');
