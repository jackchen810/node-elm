'use strict';
//const TraderHnd = require("../../process-trade/trader_phandle");
...
//策略要继承基类
module.exports = class SinaMarketClass extends BaseMarket {
    constructor(){
        super();
        ...
        http.get(this.tick_url_list, function(req, res){
            ...
            req.on('end',function(){
                ...
                for (var i = 0; i< symbol_array.length; i++) {
                    ...
                    ///symbol
                    //console.log('data_substr:', data_substr);
                   ...
                   // symbol_array[i];
                    ...
                    //TraderHnd.onTick([tick_data]);
                    self.create_bar_min(tick_data, '1', function (barObj) {
                        console.log('[market] send tobar data:', barObj);
                        self.to_bar('1', barObj);
                    });
                    self.create_bar_min(tick_data, '5', function (barObj) {
                        self.to_bar('5', barObj);
                    });

                }

                //TraderHnd.onTick(message);
            });
    ...
    async on_stop(stock_symbol, stock_ktype) {
        console.log(__filename, 'on_stop:', stock_symbol, stock_ktype);
...
//console.log('create trader SinaMarketClass');

//导出模块
//module.exports = SinaMarketClass;
